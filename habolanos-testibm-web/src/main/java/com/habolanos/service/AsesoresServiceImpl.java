...
public class AsesoresServiceImpl implements AsesoresService {
    ...
    /**
     * Repository injected by Spring that manages Asesores entities
     *
     */
    @Autowired
    ...
    */
    ...
    public void saveAsesores(Asesores entity) throws Exception {
        ...
        try {
            ...
            if (getAsesores(entity.getIdAsesor()) != null) {
    ...
    public void deleteAsesores(Asesores entity) throws Exception {
        ...
        if (entity.getIdAsesor() == null) {
            throw new ZMessManager().new EmptyFieldException("idAsesor");
        }

        List<TarjetasCredito> tarjetasCreditos = null;

        try {
            tarjetasCreditos = tarjetasCreditoRepository.findByProperty("asesores.idAsesor",
                    entity.getIdAsesor());

            if (Utilities.validationsList(tarjetasCreditos) == true) {
                throw new ZMessManager().new DeletingException(
                    "tarjetasCreditos");
            }

            asesoresRepository.deleteById(entity.getIdAsesor());
    ...
    public Asesores getAsesores(Long idAsesor) throws Exception {
        ...
        try {
            if (asesoresRepository.findById(idAsesor).isPresent()) {
                entity = asesoresRepository.findById(idAsesor).get();
            }
        } catch (Exception e) {
